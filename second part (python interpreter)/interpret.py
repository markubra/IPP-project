    ...
    def execute(self):
        ...
        if arg1.get_type() == "var":
            ...
            if arg1.get_value() == None:
                ...
                unicodes = re.findall(r'(\\[0-9]{3})+', data)
                for unicode in unicodes:
                    char = chr(int(unicode[1:]))
                    data = data.replace(unicode, char)
            ...
            print("bad types of operands in MOVE instruction")
            exit(53)
...
class WRITE(Instruction):
    ...
    def execute(self):
        ...
        if self.get_arg(0).get_type() == "var":
            ...
            print("bad operand type WRITE " + self.get_order())
            exit(53)
    ...
    def execute(self):
        if self.get_arg(0).get_type() == "var":
            ...
            if self.get_arg(1).get_type() == "string" and self.get_arg(2).get_type() == "string":
                ...
                print("operands must be same type in CONCAT")
                exit(53)

            try:
                result = value1 + value2
            except:
                print("error 53: operand must be same type in CONCAT")
                exit(53)
            finally:
...
class LT(Instruction):
    ...
    def execute(self):
        ...
        if (isinstance(value1, Nil) or value1 == Nil) or (isinstance(value2, Nil) or value2 == Nil):
            print("error 53: nil type in LT")
            exit(53)
        result = None
        try:
            result = value1 < value2
        except:
            print("error 53: operands in LT instruction must be the same type")
            exit(53)
        store_var(self.get_arg(0).get_value().split("@", 1)[0], self.get_arg(0).get_value().split("@", 1)[1], result)
...
class GT(Instruction):
    ...
    def execute(self):
        ...
        if (isinstance(value1, Nil) or value1 == Nil) or (isinstance(value2, Nil) or value2 == Nil):
            print("error 53: nil type in GT")
            exit(53)
        result = None
        try:
            result = value1 > value2
        except:
            print("error 53: operands in GT instruction must be the same type")
            exit(53)
        store_var(self.get_arg(0).get_value().split("@", 1)[0], self.get_arg(0).get_value().split("@", 1)[1], result)
    ...
    def execute(self):
        ...
        if (isinstance(value1, Nil) or value1 == Nil) and (isinstance(value2, Nil) or value2 == Nil):
            ...
            try:
                ...
                print("error 53: operands in EQ instruction must be the same type")
                exit(53)
        store_var(self.get_arg(0).get_value().split("@", 1)[0], self.get_arg(0).get_value().split("@", 1)[1], result)
    ...
    def execute(self):
        ...
        if (isinstance(value1, Nil) or value1 == Nil) and (isinstance(value2, Nil) or value2 == Nil):
            ...
            try:
                ...
                print("error 53: operands in JUMPIFEQ instruction must be the same type")
                exit(53)
        if result == True:
            dst = self.get_arg(0).get_value()
            if dst in labels:
                ...
                print("label \"" + dst + "\" does not exist")
                exit(52)
    ...
    def execute(self):
        ...
        if (isinstance(value1, Nil) or value1 == Nil) and (isinstance(value2, Nil) or value2 == Nil):
            ...
            try:
                ...
                print("error 53: operands in JUMPIFNEQ instruction must be the same type")
                exit(53)
        if result == True:
            dst = self.get_arg(0).get_value()
            if dst in labels:
...
class EXIT(Instruction):
    ...
    def execute(self):
        ...
        if value < 0 or value > 49:
            print("exit code must between 0 and 49 (included)")
            exit(57)
        else:
            exit(value)
...
class DPRINT(Instruction):
    ...
    def execute(self):
        ...
        if self.get_arg(0).get_type() == "var":
            ...
            # never bad operand according to the task
            print("bad operand type DPRINT " + self.get_order())
            exit(53)
    ...
    def execute(self):
        ...
        if self.get_arg(1).get_type() == "var":
            ...
            if (not isinstance(data, str)):
                print("bad operands in STRI2INT")
                exit(53)
        ...
        if position >= len(data):
            print("index in STRI2INT is out of range")
            exit(58)

        try:
            result = ord(data[position])
        except:
            print("error in STRI2INT")
            exit(58)
...
class GETCHAR(Instruction):
    ...
    def execute(self):
        ...
        position = get_int(self.get_arg(2))
        if position >= len(data):
            print("index in GETCHAR is out of range")
            exit(58)

        try:
            result = data[position]
        except:
            print("error in GETCHAR")
            exit(58)
...
class SETCHAR(Instruction):
    ...
    def execute(self):
        ...
        if position >= len(value):
            print("index in SETCHAR is out of range")
            exit(58)

        try:
            value = value[:position] + data[0] + value[position + 1:]
        except:
            print("error in SETCHAR")
            exit(58)
...
def get_any(arg):
    if arg.get_type() == "var":
        ...
        print("bad type of " + arg.get_value())
        exit(53)
...
def store_var(frame, key, value):
    if frame == "GF":
        if key in GF:
            ...
            print("var with name " + key + " doesn't exist in GF")
            exit(54)
        ...
        if len(LF_stack) != 0:
            ...
            if key in LF.get_vars():
                ...
                print("var with name " + key + " doesn't exist in LF")
                exit(54)
        else:
        ...
        if TF != None:
            if key in TF.get_vars():
                ...
                print("var with name " + key + " doesn't exist in TF")
                exit(54)
        else:
...
def parse_args():
    ...
    parser.add_argument('--source', nargs=1, type=str, help="specify the output file")
    parser.add_argument('--input', nargs=1, type=str, help="specify the input file")
    try:
...
def read_input():
    ...
    if input_file != None:
        try:
            ...
            print("it was impossible to open the input-file")
            exit(11)
